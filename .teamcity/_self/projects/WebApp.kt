	...
	steps {
		...
		bashNodeScript {
			...
			scriptContent = """
				...
				yarn magellan --config=magellan.json --max_workers=%E2E_WORKERS% --suiteTag=parallel --mocha_args="--reporter mocha-teamcity-reporter" --local_browser=chrome --test=${'$'}{TEST_FILES}
			""".trimIndent()
			dockerImage = "%docker_image_e2e%"
